...
/**
* The same payments contract + an authorizeMe() function that allows anyone to
* become authorized mint tokens to make testing on Rinkeby interesting
*/
...
contract Payments is Authorization {
    ...
    /**
    * @dev Allows anyone to become authorized to mint tokens. Intended to make
    * testing the contract / front-end on Rinkeby interesting.
    * NOTE: this is not remotely secure
    */
